...
def data_storage(x1, y1, phid, phit, t, u1='', T='', z1='', x2='', y2='', z2='', rudder_angle=''):
    ...
    with open(y1_save, 'a') as obj:
        obj.write('\n' + str(y1[-1]))
    phid_save = 'D:\\Wave glider modelling\\data\\phid.json'
    with open(phid_save, 'a') as obj:
        obj.write('\n' + str(phid[-1]))
...
def data_elimation():
    ...
    open('D:\\Wave glider modelling\\data\\phid.json', 'w').close()
    ...
    os.remove(r'D:\\Wave glider modelling\\data\\phid.json')
